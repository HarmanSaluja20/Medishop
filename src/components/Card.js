  ...
  const handleAddToCart = async () => {
    ...
    if (med !== []) {
      if (med.size === size) {
        ...
        await dispatch({ type: "ADD", id: medItem._id, name: medItem.name, price: finalPrice, qty: qty, size: size,img: props.ImgSrc })
    ...
    <div>
      ...
      <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px" }}>
        ...
        <div className="card-body">
          <h5 className="card-title">{props.medName}</h5>
